package com.sgcc.pms.zbztjc.kqxt.bdgjxxcxtj_query.bizc;
...
import com.sgcc.pms.zbztjc.kqxt.sdgjxxcxtj_query.bizc.Sdgjxxcxtj_queryBizc;
...
public class Bdgjxxcxtj_queryBizc implements IBdgjxxcxtj_queryBizc{
	...
	public QueryResultObject query(RequestCondition queryCondition) {
		...
		String cols = "OBJ_ID,LINKEDPROVICEDEPT,LINKEDDEPMC,WSDEPMC,LINKEDSTATIONNAME,XTMC,LINKEDEQUIPMENTNAME,DEVICEVOLTAGE," +
				"DEVICENAME,TYPENAME,ALARMTIME,ALARMLEVEL,CONTINUANCETIME,ALARMMESSAGE,ishandledName,ishandled";
		
		StringBuffer querySql = new StringBuffer();
		
		String sql = "select CAST(t.OBJ_ID AS VARCHAR2(42)) OBJ_ID,t.linkeddep,t.LINKEDDEPWS,t.WSDEPMC,T.LINKEDSTATIONNAME,t.XTMC,t.LINKEDEQUIPMENTNAME," +
	...
	public List queryDatailById(String id) {
		...
		StringBuffer querySql = new StringBuffer();
		//querySql.append(SqlFileUtil.get("select_BDgjxxcxtjQuery_queryDatailById"));
