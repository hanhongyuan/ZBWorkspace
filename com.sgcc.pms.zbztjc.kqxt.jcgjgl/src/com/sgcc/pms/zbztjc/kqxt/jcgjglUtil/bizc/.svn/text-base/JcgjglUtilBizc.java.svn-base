package com.sgcc.pms.zbztjc.kqxt.jcgjglUtil.bizc;
...
public class JcgjglUtilBizc implements IJcgjglUtilBizc{
	@Resource
	private IHibernateDao hibernateDao_ztjc;
	
	private final static Log log = LogFactory.getLog(JcgjglUtilBizc.class);
