...
bdzztj.views.bdzztjByDydjMainViewController = function()
{
    ...
    me._initBdDydjDataGrid = function(){
	    var _dataGrid = me.view.getDataGrid();
	    	_col = _dataGrid.$body.find("td").not("#OBJ_ID,#SSWSMC,#ALLZZZS,#ALLFGBDZS,#ALLBDZZS,#ALLFGL,#FGL37,#rownumber,#FGL36,#FGL35,#FGL34,#FGL33,#FGL32,#FGL30,#FGL25,#FGL86,#FGL85,#FGL84,#FGL83,#FGL82,#FGL81,#FGL80,#BDZZS37,#BDZZS36,#BDZZS35,#BDZZS34,#BDZZS33,#BDZZS32,#BDZZS30,#BDZZS25,#BDZZS86,#BDZZS85,#BDZZS84,#BDZZS83,#BDZZS82,#BDZZS81,#BDZZS80");
    	 ...
    	 try {
    		 var _dataGrid = me.view.getDataGrid();
    	    	var util = new mxpms.utils.FormDocumentUtil({
    	    		title:"",
    	    		view : _dataGrid.$grid,
    	    		fileName:"变电监测装置按电压等级统计"
    	    	});
    	    	 util.exportExcel(); 
    	    	 var czlx = "导出";												//此处为操作方式：新增/修改/删除 任选其一
    				var transactionType = "状态监测-监测装置管理-变电监测装置按电压等级统计";		//此处为页面的菜单路径信息
