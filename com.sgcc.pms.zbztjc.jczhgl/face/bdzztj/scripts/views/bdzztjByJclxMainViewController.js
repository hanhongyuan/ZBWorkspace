...
bdzztj.views.bdzztjByJclxMainViewController = function() {
	...
	me._initBdJclxDataGrid = function(){
	    var _dataGrid = me.view.getDataGrid();
	    	_col = _dataGrid.$body.find("td").not("#OBJ_ID,#SSWSMC,#ALLZZZS,#FGL37,#rownumber,#FGL36,#FGL35,#FGL34,#FGL33,#FGL32,#FGL30,#FGL25,#FGL86,#FGL85,#FGL84,#FGL83,#FGL82,#FGL81,#FGL80");
	...
	showBdJclxDetail = function(item, colName) {
		...
		var jclxMap={"021001":"变压器局部放电","021002":"油中溶解气体","021003":"微水","021004":"铁芯接地电流","021005":"顶层油温","021007":"变压器振动波谱","022001":"电容绝缘监测","023001":"金属氧化物避雷器绝缘监测","024001":"断路器局部放电","024002":"分合闸线圈电流波形","024003":"负荷电流波形","024004":"SF6气体压力","024005":"SF6气体水分","024006":"储能电机工作状态","026001":"变电视频监测"};
    	 ...
    	 try {
    		 var _dataGrid = me.view.getDataGrid();
    	    	var util = new mxpms.utils.FormDocumentUtil({
    	    		title:"",
    	    		view : _dataGrid.$grid,
    	    		fileName:"变电监测装置按监测类型统计"
    	    	});
    	    	 util.exportExcel(); 
    	    	 var czlx = "导出";												//此处为操作方式：新增/修改/删除 任选其一
    				var transactionType = "状态监测-监测装置管理-变电监测装置按监测类型统计";		//此处为页面的菜单路径信息
