$ns("sdzztjfx.views");
$import("sdzztjfx.views.sdzztjfxMainView");
...
sdzztjfx.views.sdzztjfxMainViewController = function()
{
    var me = $extend(mx.views.ViewController);
    var base = {};
    var text = "以下为(全网)监测装置统计";
    me.urlUp = "~/rest/sdzztjfxcontrol/queryByssdw";
    me.urlDownJclx = "~/rest/sdzztjfxcontrol/queryByjclx";
    me.urlDownDydj = "~/rest/sdzztjfxcontrol/queryBydydj";
    me.urlDownSccj = "~/rest/sdzztjfxcontrol/queryBysccj";
    var filter = "ssdw=63EBEC8E-E766-40D7-ACF4-FEA945102112-00042";
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new sdzztjfx.views.sdzztjfxMainView({ controller: me });
        }
        return me.view;
    };
