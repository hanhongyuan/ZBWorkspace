...
$import("dlzztj.views.MainViewController");

dlzzcxtj.views.MainView = function()
{
    ...
    function _initControl(){
    	me.queryController = dlzzcx.views.MainViewController();
    	me.statController = dlzztj.views.MainViewController();		
