$ns("sdzztj.views");
$import("sdzztj.views.sdzzxxDetailMainView");
$import("sdzztj.views.sdzztjByDydjMainViewController");

sdzztj.views.sdzzxxDetailMainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new sdzztj.views.sdzzxxDetailMainView({ controller: me });
        }
        return me.view;
    };
