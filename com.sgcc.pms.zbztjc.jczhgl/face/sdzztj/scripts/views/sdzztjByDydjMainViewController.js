...
sdzztj.views.sdzztjByDydjMainViewController = function()
{
    ...
    me._initSdDydjDataGrid = function(){
	    var _dataGrid = me.view.getDataGrid();
	    	_col = _dataGrid.$body.find("td").not("#OBJ_ID,#SSWSMC,#ALLZZZS,#ALLFGXLZS,#ALLXLZS,#ALLFGL,#FGL37,#rownumber,#FGL36,#FGL35,#FGL34,#FGL33,#FGL32,#FGL30,#FGL25,#FGL86,#FGL85,#FGL84,#FGL83,#FGL82,#FGL81,#FGL80,#XLZS37,#XLZS36,#XLZS35,#XLZS34,#XLZS33,#XLZS32,#XLZS30,#XLZS25,#XLZS86,#XLZS85,#XLZS84,#XLZS83,#XLZS82,#XLZS81,#XLZS80");
...
//		sdzzcxtjDetailView.searchBox.editors[1].setEnabled(false);
    ...
    me._dydjExportBtn_click = function(){
     	...
     	try {
            ...
            view:_dataGrid.$grid,
               //fileName为导出的文档名称
            fileName:"输电监测装置按电压等级统计"
            });
         	util.exportExcel(); 
         	var czlx = "导出";												//此处为操作方式：新增/修改/删除 任选其一
			var transactionType = "状态监测-监测装置管理-输电监测装置按电压等级统计";		//此处为页面的菜单路径信息
