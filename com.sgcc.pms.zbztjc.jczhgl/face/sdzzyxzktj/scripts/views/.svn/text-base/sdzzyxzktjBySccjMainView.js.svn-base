...
sdzzyxzktj.views.sdzzyxzktjBySccjMainView = function()
{
	...
	function _initDataGrid() {
		var restUrl = "~/rest/sdzzyxzkcontrol/sccjtj";
		...
		_dataGrid = new mx.datacontrols.GroupHeaderGrid({
			...
			, {
				...
				caption : "视频",
				columns :[
						{ name: "ZZZS018003", caption: "装置数", dataAlign:"center",editorType: "TextEditor" },
						{ name: "SSJR018003", caption: "实时接入装置数", dataAlign:"center",editorType: "TextEditor" },
						{ name: "JRL018003", caption: "实时接入率", dataAlign:"center",editorType: "TextEditor" }
						//{ name: "JRL018003", caption: "数据接入率", dataAlign:"center",editorType: "TextEditor" },
						//{ name: "ZQL018003", caption: "数据准确率", dataAlign:"center",editorType: "TextEditor" },
						//{ name: "DF018003", caption: "得分", dataAlign:"center",editorType: "TextEditor" }
						]
			}
			...
			, {
				...
				columns :[
						...
						//{ name: "ZQL018002", caption: "数据准确率", dataAlign:"center",editorType: "TextEditor" },
