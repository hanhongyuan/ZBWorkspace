...
sdkhzb.views.sddataDetailMainView = function()
{
    ...
    function _initSearchBox(){
    	me.searchBox = new mxpms.datacontrols.AdvancedSearchBox({
			alias:"SdzzcxtjDetail_searchbox",
			rootGroupId : "402881704230292b0142316493220006",
			PagedControl:me.dataGrid,
			height:95,
			itemNumOfRow:4,
			fields : [ {name : "ssdw",caption : "所属单位",displayCheckBox:true,editorType : "DropDownEditor",
 ...
 function _initDataGrid(){
    	...
    	var restUrl = "~/rest/sdkhzbControl/getdataDetailList";
		...
		me.dataGrid = new mx.datacontrols.DataGrid({
			...
			columns:[
						{	name: "PROVINCE_NAME", caption: "所属单位" , editorType: "TextEditor",width:120},
						{	name: "LINKEDLINENAME", caption: "所属线路" , editorType: "TextEditor",width:120},
	     				{	name: "LINKEDPOLENAME", caption: "所属杆塔" , editorType: "TextEditor",width:120},
	     				{	name: "TYPENAME", caption: "装置类型" , editorType: "TextEditor",width:80},
	     				{	name: "DEVICENAME", caption: "装置名称" , editorType: "TextEditor",width:120},
	     				{	name: "DEVICECODE", caption: "装置编码" , editorType: "TextEditor"	,width:140},
	     				{	name: "MANUFACTURER", caption: "生产厂家" , editorType: "TextEditor"	,width:120},
	     				{	name: "ALLSCORED", caption: "总得分" , editorType: "TextEditor"	,width:120},
	     				{	name: "DATAACCESSRATE", caption: "数据接入率" , editorType: "TextEditor"	,width:120},
	     				{	name: "ACCESSRATESCORED", caption: "接入率得分" , editorType: "TextEditor"	,width:120},
	     				{	name: "ARACCURACYRATESCORED", caption: "准确率得分" , editorType: "TextEditor"	,width:120},
	     				{	name: "ERRORRATESCORED", caption: "误报率得分" , editorType: "TextEditor"	,width:120},
	     				{	name: "BREAKDOWNSTIME", caption: "故障时间" , editorType: "TextEditor"	,width:120},
	     				{	name: "DOWNSTIMESCORED", caption: "故障时间得分" , editorType: "TextEditor"	,width:120},
	     				{	name: "TJMONTH", caption: "统计月份" , editorType: "TextEditor"	,width:120}
	     				],
