...
sdkhzb.views.sdkhzbDetailMainView = function()
{
 ...
 function _initDataGrid(){
    	...
    	var restUrl = "~/rest/sdkhzbControl/getDetailList";
		...
		me.dataGrid = new mx.datacontrols.DataGrid({
			...
			columns:[
						...
						{	name: "LINKEDLINENAME", caption: "所属线路" , editorType: "TextEditor",width:120},
	     				...
	     				{	name: "IMAGEEFFECTIVERATE", caption: "图像有效率" , editorType: "TextEditor"	,width:120},
	     				{	name: "EFFECTIVERATESCORED", caption: "有效率得分" , editorType: "TextEditor"	,width:120},
	     				{	name: "BREAKDOWNSTIME", caption: "故障时间(得分)" , editorType: "TextEditor"	,width:120},
	     				{	name: "DOWNSTIMESCORED", caption: "故障得分" , editorType: "TextEditor"	,width:120},
