$ns("sdkhzb.views");
$import("sdkhzb.views.sddataDetailMainView");

sdkhzb.views.sddataDetailMainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new sdkhzb.views.sddataDetailMainView({ controller: me });
        }
        return me.view;
    };
