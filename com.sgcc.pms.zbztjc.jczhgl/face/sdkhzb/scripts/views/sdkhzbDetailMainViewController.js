$ns("sdkhzb.views");
$import("sdkhzb.views.sdkhzbDetailMainView");

sdkhzb.views.sdkhzbDetailMainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new sdkhzb.views.sdkhzbDetailMainView({ controller: me });
        }
        return me.view;
    };
