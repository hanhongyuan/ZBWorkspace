...
dlzztj.views.dlzzxxDetailMainView = function()
{
...
//		});
    ...
    function _initSearchBox(){
    	me.searchBox = new mxpms.datacontrols.AdvancedSearchBox({
			alias:"BdzzcxtjDetail_searchbox",
			...
			{	name : "dlmc",caption : "电力电缆及通道名称",displayCheckBox : false,hint:"---请输入---",displayCloseButton : false,editorType : "TextEditor"},
		...
		me.searchBox.$("#dlmc").css("width","200px");
		me.searchBox.$("#tyrq").css("width","200px");
		me.searchBox.$("#sfss").css("width","300px");
 ...
 function _initDataGrid(){
    	...
    	var restUrl = "~/rest/zbdlzzcxtjController/getDetailList";
