$ns("bdzzyxzktj.views");
$import("bdzzyxzktj.views.bdzzyxzktjBySccjMainView");
$import("bdzzyxzktj.views.bdzzyxzkDetailMainViewController");

bdzzyxzktj.views.bdzzyxzktjBySccjMainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new bdzzyxzktj.views.bdzzyxzktjBySccjMainView({ controller: me });
        }
        return me.view;
    };
   ...
   me._initBdSccjDataGrid = function(){
	    ...
	    _col = _dataGrid.$body.find("td").not("#rownumber,#OBJ_ID,#SSWSMC,#SSJRL021001,#SSJRL021002,#SSJRL021003,#SSJRL021004,#SSJRL021005,#SSJRL022001,#SSJRL023001,#SSJRL024001,#SSJRL024002,#SSJRL024003,#SSJRL024004,#SSJRL024005,#SSJRL024006,#SSJRL026001,#SSJRL021007,#SSJRZZS021001,#SSJRZZS021002,#SSJRZZS021003,#SSJRZZS021004,#SSJRZZS021005,#SSJRZZS022001,#SSJRZZS023001,#SSJRZZS024001,#SSJRZZS024002,#SSJRZZS024003,#SSJRZZS024004,#SSJRZZS024005,#SSJRZZS024006,#SSJRZZS026001,#SSJRZZS021007,#WSSJRS021001,#WSSJRS021002,#WSSJRS021003,#WSSJRS021004,#WSSJRS021005,#WSSJRS022001,#WSSJRS023001,#WSSJRS024001,#WSSJRS024002,#WSSJRS024003,#WSSJRS024004,#WSSJRS024005,#WSSJRS024006,#WSSJRS026001,#WSSJRS021007,#ALLZZZS,#ALLSSJRZZS,#ALLSSJRL,#ALLWSSJRS");
