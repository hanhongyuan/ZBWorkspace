$ns("khztInfo.views");
$import("khztInfo.views.MainView");

khztInfo.views.MainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new khztInfo.views.MainView({ controller: me });
        }
        return me.view;
    };
