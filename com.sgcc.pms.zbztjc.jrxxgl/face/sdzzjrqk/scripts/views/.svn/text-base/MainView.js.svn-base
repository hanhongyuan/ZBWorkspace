...
sdzzjrqk.views.MainView = function()
{
    ...
    {
    	/* 初始化 EntityContainer */
    	var restUrl ="~/rest/zzjrqkcx/getSdData";
		var gridEntityContainer = new mx.datacontainers.GridEntityContainer({
			baseUrl : sdzzjrqk.mappath(restUrl),
			loadMeta : false,
			iscID : "-1"
		});
	 ...
	 /* 初始化 DataGrid */
        me.dataGrid = new mx.datacontrols.ComplexGrid({      
            columns:[
            	...
            	{	name: "linkedlinename", caption: "线路名称" , editorType: "TextEditor"	},
            	{	name: "linkedpolename", caption: "杆塔名称" , editorType: "TextEditor"	},
            	...
            	{	name: "sfss", caption: "是否实时" , editorType: "TextEditor",
