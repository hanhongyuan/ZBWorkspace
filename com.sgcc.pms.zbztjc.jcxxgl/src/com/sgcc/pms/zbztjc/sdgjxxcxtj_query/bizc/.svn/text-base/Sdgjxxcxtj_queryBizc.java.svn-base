package com.sgcc.pms.zbztjc.sdgjxxcxtj_query.bizc;
...
public class Sdgjxxcxtj_queryBizc implements ISdgjxxcxtj_queryBizc{
	...
	public QueryResultObject query(RequestCondition queryCondition) {
		...
		String colsTransf = "CAST(OBJ_ID AS VARCHAR2(42)) OBJ_ID,LINKEDPROVICEDEPT,LINKEDDEPMC,WSDEPMC,LINKEDLINENAME," +
				"LINKEDPOLENAME,DEVICEVOLTAGE,DEVICENAME,TYPENAME,TO_CHAR(ALARMTIME,'YYYY-MM-DD HH24:MI:SS') ALARMTIME,ALARMLEVEL,nvl(CONTINUANCETIME,0) CONTINUANCETIME,ALARMMESSAGE," +
				" DECODE(ishandled,'T','是','F','否','','否',NULL,'否') ishandledName";
		String cols = "OBJ_ID,LINKEDPROVICEDEPT,LINKEDDEPMC,WSDEPMC,LINKEDLINENAME,LINKEDPOLENAME,DEVICEVOLTAGE," +
