...
bdgjxxcxtj_stat.views.statByDydjMainView = function()
{
    ...
    function _initSearchBox(){
    	me.searchBox = new mxpms.datacontrols.AdvancedSearchBox({
			alias:"bdgjxxcxtj_statByDydj_searchbox",
		...
		me.searchBox.editors.bdz.setWidth("180px");
    ...
    function _initDataGrid(){
    	var restUrl = "~/rest/bdgjxxcxtj_stat/dydjtj";
		/* 初始化 EntityContainer */
	...
	{
		var bdz = me.searchBox.editors.bdz.value;
		
		if(bdz!=null&&bdz!="")
		{
			if(bdz.length>50|| !pattern1.test(bdz)){
				me.searchBox.editors.bdz.reset();
