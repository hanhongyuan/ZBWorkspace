...
$import("bdgjxxcxtj_stat.views.statByDydjMainViewController");
$import("bdgjxxcxtj_stat.views.statByJclxMainViewController");

bdgjxxcxtj_stat.views.MainView = function()
{
    ...
    function _init_Control(){
    	me.statByDydjController = bdgjxxcxtj_stat.views.statByDydjMainViewController();		//获取按电压等级统计的Controller
    	me.statByJclxController = bdgjxxcxtj_stat.views.statByJclxMainViewController();		//获取按监测类型统计的Controller
