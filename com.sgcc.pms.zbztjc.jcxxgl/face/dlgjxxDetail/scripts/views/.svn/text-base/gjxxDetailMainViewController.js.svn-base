...
$import("dlgjxxDetail.views.gjxxDetailMainView");
$import("openChart.views.MainViewController");
dlgjxxDetail.views.gjxxDetailMainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new dlgjxxDetail.views.gjxxDetailMainView({ controller: me });
        }
        return me.view;
    };
