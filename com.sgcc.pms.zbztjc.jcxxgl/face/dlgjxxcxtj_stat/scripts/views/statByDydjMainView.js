...
$import("mxpms.datacontrols.AdvancedSearchBox");
$import("mx.datacontrols.GroupHeaderGrid");

dlgjxxcxtj_stat.views.statByDydjMainView = function()
{
    ...
    function _initSearchBox(){
    	me.searchBox = new mxpms.datacontrols.AdvancedSearchBox({
			alias:"dlgjxxcxtj_statByDydj_searchbox",
    ...
    function _initDataGrid(){
    	var restUrl = "~/rest/dlgjxxcxtj_stat/dydjtj";
		/* 初始化 EntityContainer */
