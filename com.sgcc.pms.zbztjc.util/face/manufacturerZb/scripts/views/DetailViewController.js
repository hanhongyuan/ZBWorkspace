...
$import("manufacturerZb.views.DetailView");

manufacturerZb.views.DetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new manufacturerZb.views.DetailView({controller: me, alias:"manufacturerZbDetailView"});
        }
        return me.view;
    };
