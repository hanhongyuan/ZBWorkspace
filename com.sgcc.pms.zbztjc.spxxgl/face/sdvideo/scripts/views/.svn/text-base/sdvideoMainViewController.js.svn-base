...
sdvideo.views.sdvideoMainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new sdvideo.views.sdvideoMainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._btnLookOne = function(param){
    	...
    	var url = "../showvideo/index.jsp?type=sd&videocode="+videocode+"&name="+name;
    	var d_width = "950";
    	var d_height = "450";
