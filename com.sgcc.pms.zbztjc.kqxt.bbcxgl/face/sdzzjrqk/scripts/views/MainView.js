...
sdzzjrqk.views.MainView = function()
{
    ...
    {
        var restUrl = "~/rest/sdzzjrqk/getSdData";
		/* 初始化 EntityContainer */
	 ...
	 /* 初始化 DataGrid */
        me.dataGrid = new mx.datacontrols.ComplexGrid({     
            columns:[
            	...
            	{	name: "linkedlinename", caption: "线路名称" , editorType: "TextEditor",width:"10%"},
            	{	name: "linkedpolename", caption: "杆塔名称" , editorType: "TextEditor",width:"10%"},
