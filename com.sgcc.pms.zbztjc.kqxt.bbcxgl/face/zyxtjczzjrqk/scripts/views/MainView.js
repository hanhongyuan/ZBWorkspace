...
zyxtjczzjrqk.views.MainView = function()
{
    ...
    {
        var restUrl = "~/rest/zyxtjczzjrqk/getZyxtData";
		/* 初始化 EntityContainer */
		var gridEntityContainer = new mx.datacontainers.GridEntityContainer({
			baseUrl : zyxtjczzjrqk.mappath(restUrl),
			loadMeta : false,
	 ...
	 /* 初始化 DataGrid */
        me.dataGrid = new mx.datacontrols.ComplexGrid({     
            columns:[
            	...
            	{	name: "xtmc", caption: "所属系统" , editorType: "DropDownEditor",width:"10%"},
            	{	name: "linkedlinename", caption: "线路名称/变电站名称" , editorType: "TextEditor",width:"10%"},
            	{	name: "linkedpolename", caption: "杆塔名称/设备名称" , editorType: "TextEditor",width:"10%"},
            ...
            searchBox: new mx.datacontrols.DataGridSearchBox({
                fields: [
                	...
                	{	name: "xtmc", caption: "所属系统" , editorType: "DropDownEditor",hint : "--请选择--",displayCheckBox:"true"	},
                	...
                	{	name: "linkedlinename", caption: "线路名称" , editorType: "TextEditor",hint : "--请输入--"	},
                	{	name: "linkedstationname", caption: "变电站名称" , editorType: "TextEditor",hint : "--请输入--"},
                	{	name: "sfss", caption: "是否实时" , editorType: "DropDownEditor",hint : "--请选择--",displayCheckBox:"true"}
                ],
                 itemNumOfRow : 4,
