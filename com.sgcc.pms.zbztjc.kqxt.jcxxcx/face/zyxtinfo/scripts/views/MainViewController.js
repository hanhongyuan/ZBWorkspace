$ns("zyxtinfo.views");
$import("zyxtinfo.views.MainView");

zyxtinfo.views.MainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new zyxtinfo.views.MainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._initDataGridSD = function()
    {
    	...
    	for(var i=0;i<_col.length;i++){
			if("0" != _col[i].innerText && "" != _col[i].innerText ){
	    		_col[i].setAttribute("class","zyxtcx");
	    	}
		}
    	
    	_dataGrid.$body.find(".zyxtcx").click(function(e) {
