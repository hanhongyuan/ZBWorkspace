...
bdzztj.views.bdzzxxDetailMainView = function()
{
...
/*    	// 查询区的隐藏和显示图标的点击事件
 ...
 function _initDataGrid(){
    	...
    	var restUrl = "~/rest/zbbdzzcxtjControl/getDetailList";
	     				...
	     				{	name: "LOOKUP", caption: "监测信息" , editorType: "TextEditor",width:80,
	     					renderCell: function(s,p){
	      		        		var objIdValue = s.values.OBJ_ID;
		   						p.html("<a href=\"javascript: void(0);\" style=\"color:blue;text-decoration:none;text-align:center;cursor:pointer \" onclick=\"queryMonitoringInfo_click('"+objIdValue+"')\">查看</a>");
	      		        	}
	     				},
	     				{
							name : "ISRT",
