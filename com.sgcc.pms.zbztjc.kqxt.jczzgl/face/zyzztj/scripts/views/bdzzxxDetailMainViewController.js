$ns("zyzztj.views");
$import("zyzztj.views.bdzzxxDetailMainView");

zyzztj.views.bdzzxxDetailMainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new zyzztj.views.bdzzxxDetailMainView({ controller: me });
        }
        return me.view;
    };
