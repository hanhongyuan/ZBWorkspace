...
zyzztj.views.zyxtinfoMainView = function()
{
    ...
    {
    	var restUrl = "~/rest/zbzyzzcxtjControl/loadxtsd";
		/* 初始化 EntityContainer */
    ...
    {
    	var restUrl = "~/rest/zbzyzzcxtjControl/loadxtbd";
		/* 初始化 EntityContainer */
		var gridEntityContainer = new mx.datacontainers.GridEntityContainer({
			baseUrl : zyzztj.mappath(restUrl),
			loadMeta : false,
    ...
    {
    	var restUrl = "~/rest/zbzyzzcxtjControl/loadcx";
		/* 初始化 EntityContainer */
		var gridEntityContainer = new mx.datacontainers.GridEntityContainer({
			baseUrl : zyzztj.mappath(restUrl),
			loadMeta : false,
