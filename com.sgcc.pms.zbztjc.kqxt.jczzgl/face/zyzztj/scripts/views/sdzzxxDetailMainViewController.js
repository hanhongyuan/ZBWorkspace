$ns("zyzztj.views");
$import("zyzztj.views.sdzzxxDetailMainView");

zyzztj.views.sdzzxxDetailMainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new zyzztj.views.sdzzxxDetailMainView({ controller: me });
        }
        return me.view;
    };
