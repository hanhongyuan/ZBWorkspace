...
$import("zyzzcx.views.zyzzcxMainViewController");
$import("zyzztj.views.MainViewController");

zyzzcxtj.views.MainView = function()
{
    ...
    function _initControl(){
    	me.queryController = zyzzcx.views.zyzzcxMainViewController();
    	me.statController = zyzztj.views.MainViewController();
