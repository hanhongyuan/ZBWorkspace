$ns("bdzzyxzktj.views");
$import("bdzzyxzktj.views.bdzzyxzkDetailMainView");

bdzzyxzktj.views.bdzzyxzkDetailMainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new bdzzyxzktj.views.bdzzyxzkDetailMainView({ controller: me });
        }
        return me.view;
    };
