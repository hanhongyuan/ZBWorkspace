...
$import("sdzzyxzktj.views.sdzzxxTwoDetailViewController");
...
sdzzyxzktj.views.sdzzyxzktjByDydjMainViewController = function()
{
    ...
    me._initSdDydjDataGrid = function(){
	    var _dataGrid = me.view.getDataGrid();
	    	_col = _dataGrid.$body.find("td").not("#OBJ_ID,#SSWSMC,#ALLZZZS,#ALLSSJRZS,#ALLSSJRL,#ALLWSSJR,#rownumber,#SSJRLZS37,#SSJRLZS36,#SSJRLZS35,#SSJRLZS34,#SSJRLZS33,#SSJRLZS32,#SSJRLZS30,#SSJRLZS25,#SSJRLZS86,#SSJRLZS85,#SSJRLZS84,#SSJRLZS83,#SSJRLZS82,#SSJRLZS81,#SSJRLZS80,#SSJRL37,#SSJRL36,#SSJRL35,#SSJRL34,#SSJRL33,#SSJRL32,#SSJRL30,#SSJRL25,#SSJRL86,#SSJRL85,#SSJRL84,#SSJRL83,#SSJRL82,#SSJRL81,#SSJRL80,#SSJRLZS37,#SSJRLZS36,#SSJRLZS35,#SSJRLZS34,#SSJRLZS33,#SSJRLZS32,#SSJRLZS30,#SSJRLZS25,#SSJRLZS86,#SSJRLZS85,#SSJRLZS84,#SSJRLZS83,#SSJRLZS82,#SSJRLZS81,#SSJRLZS80,#WSSJR37,#WSSJR36,#WSSJR35,#WSSJR34,#WSSJR33,#WSSJR32,#WSSJR30,#WSSJR25,#WSSJR86,#WSSJR85,#WSSJR84,#WSSJR83,#WSSJR82,#WSSJR81,#WSSJR80");
	    	...
	    	for(var i=0;i<_col.length;i++){
				if("0" != _col[i].innerText && "" != _col[i].innerText ){
		    		_col[i].setAttribute("class","zbsdzzyxzktjLink");
		    	}
			}
	    	_dataGrid.$body.find(".zbsdzzyxzktjLink").click(function(e) {
	...
	showSdDydjDetail = function(item, colName) {
		...
		if (sdzzTwoDetailView == null) {
			var mvc = new sdzzyxzktj.views.sdzzxxTwoDetailViewController();
