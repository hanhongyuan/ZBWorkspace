$ns("sdzzyxzktj.views");
$import("sdzzyxzktj.views.sdzzxxDetailMainView");
$import("sdzzyxzktj.views.sdzzyxzktjByDydjMainViewController");

sdzzyxzktj.views.sdzzxxDetailMainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new sdzzyxzktj.views.sdzzxxDetailMainView({ controller: me });
        }
        return me.view;
    };
